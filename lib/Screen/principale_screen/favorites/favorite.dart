            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return _customPersonSmach(context, listUser[index]);
                },
...
Widget _customPersonSmach(BuildContext context, Personne person) {
  var screenWidth = MediaQuery.of(context).size.width;
  var screenHeight = MediaQuery.of(context).size.height;
  ...
  return InkWell(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PageDetaillePersonne(personne: person,),
        ),
      );
    },
    child: Stack(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage(person.profilPhoto),
              fit: BoxFit.cover,
            ),
          ),
        ),
